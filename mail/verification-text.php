...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
    <?= Yii::t(
        'app',
        'The order you have made is completed. Please click the link below and verify the order'
    ) ?>.
...
<p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6; font-weight: normal; margin: 0 0 10px; padding: 0;">
    <?= Html::a('Verify',Html::encode($verifyURL),['class'=> 'btn btn-primary']); ?>
    <?= Html::a('View',Html::encode($viewURL),['class'=> 'btn btn-primary']); ?>
</p>
